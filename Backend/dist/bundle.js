...
exports.createAffiliate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, fullName = _req$body.fullName, email = _req$body.email, password = _req$body.password, phoneNumber = _req$body.phoneNumber, companyName = _req$body.companyName, companyEmail = _req$body.companyEmail, designation = _req$body.designation;
          _context.prev = 1;
          _context.next = 4;
...
exports.getAffiliateProfile = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var affiliateId, affiliate;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          affiliateId = req.params.id; // Extract affiliate ID from request parameters
...
exports.changePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body3, affiliateId, oldPassword, newPassword, affiliate, isOldPasswordValid, hashedNewPassword;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body3 = req.body, affiliateId = _req$body3.affiliateId, oldPassword = _req$body3.oldPassword, newPassword = _req$body3.newPassword;
          _context4.prev = 1;
          _context4.next = 4;
          return Affiliate.findById(affiliateId);
        case 4:
        ...
        case 7:
          _context4.next = 9;
          return bcrypt.compare(oldPassword, affiliate.password);
        case 9:
          isOldPasswordValid = _context4.sent;
...
exports.getAffiliateCount = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return Affiliate.countDocuments();
        case 3:
        ...
        case 7:
          ...
          console.error('Error fetching affiliate count:', _context5.t0);
          res.status(500).json({
            message: 'Internal server error.'
          });
        case 11:
...
// Get all affiliates
exports.getAllAffiliates = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 9:
          ...
          console.error("Error fetching affiliates:", _context6.t0);
          res.status(500).json({
            message: "Internal server error."
          });
        case 13:
...
exports.deleteAffiliates = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var affiliateIds, result;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          affiliateIds = req.body.affiliateIds; // Expect an array of affiliate _ids
          if (!(!affiliateIds || affiliateIds.length === 0)) {
            _context7.next = 3;
            break;
          }
          return _context7.abrupt("return", res.status(400).json({
            message: "No affiliate IDs provided"
          }));
        case 3:
          _context7.prev = 3;
          _context7.next = 6;
        ...
        case 6:
          ...
          return _context7.abrupt("return", res.status(404).json({
            message: "No affiliates found to delete"
          }));
        case 9:
          res.status(200).json({
            message: "".concat(result.deletedCount, " affiliate(s) deleted successfully!")
          });
          _context7.next = 16;
          break;
        case 12:
          ...
          console.error("Error deleting affiliates:", _context7.t0);
          res.status(500).json({
            message: "Internal server error."
          });
        case 16:
...
/***/ "./controllers/affiliateJobController.js":
/*!***********************************************!*\
  !*** ./controllers/affiliateJobController.js ***!
  \***********************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
var Job = __webpack_require__(/*! ../models/AffiliateJob */ "./models/AffiliateJob.js");
var mongoose = __webpack_require__(/*! mongoose */ "mongoose");

// Create a new job posting
var createJob = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, jobTitle, skillset, experience, location, domain, salary, affiliateId, job;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, jobTitle = _req$body.jobTitle, skillset = _req$body.skillset, experience = _req$body.experience, location = _req$body.location, domain = _req$body.domain, salary = _req$body.salary;
          affiliateId = req.body.affiliateId; // Assume affiliateId is sent in the request body
          job = new Job({
            jobTitle: jobTitle,
            skillset: skillset,
...
var getJobByAffiliateId = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var affiliateId, jobs;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          affiliateId = req.params.id; // Check if the provided affiliateId is a valid ObjectId
        ...
        case 6:
          ...
          return _context3.abrupt("return", res.status(404).json({
            message: "No jobs found for this affiliate ID"
          }));
        case 9:
          res.status(200).json(jobs);
          _context3.next = 16;
  ...
  return function getJobByAffiliateId(_x5, _x6) {
    return _ref3.apply(this, arguments);
  };
}();
...
// Edit a job by ID
var editJobById = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var jobId, updates, job;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.prev = 2;
          _context5.next = 5;
          return Job.findByIdAndUpdate(jobId, updates, {
            "new": true,
  ...
  return function editJobById(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();

// Count jobs by affiliateId
var countJobsByAffiliateId = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var affiliateId, count;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
  ...
  return function countJobsByAffiliateId(_x11, _x12) {
    return _ref6.apply(this, arguments);
  };
}();
...
var getJobById = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          jobId = req.params.id; // Check if the provided jobId is a valid ObjectId
  ...
  return function getJobById(_x13, _x14) {
    return _ref7.apply(this, arguments);
  };
}();
module.exports = {
  createJob: createJob,
  getJobs: getJobs,
  getJobByAffiliateId: getJobByAffiliateId,
  // Export the new function
  deleteJob: deleteJob,
  editJobById: editJobById,
  countJobsByAffiliateId: countJobsByAffiliateId,
...
var createJobApplication = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, email, phone, jobId, affiliateId, jobTitle, resume, newApplication;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, name = _req$body.name, email = _req$body.email, phone = _req$body.phone, jobId = _req$body.jobId, affiliateId = _req$body.affiliateId, jobTitle = _req$body.jobTitle;
...
var ReferredStudent = __webpack_require__(/*! ../models/ReferredStudent */ "./models/ReferredStudent.js");

// Create and refer a student
exports.referStudent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, studentName, email, status, jobTitle, jobId, affiliateId, referredStudent, savedStudent;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _req$body = req.body, studentName = _req$body.studentName, email = _req$body.email, status = _req$body.status, jobTitle = _req$body.jobTitle, jobId = _req$body.jobId, affiliateId = _req$body.affiliateId;
          referredStudent = new ReferredStudent({
        ...
        case 9:
          ...
          _context.t0 = _context["catch"](0);
          res.status(500).json({
            message: "Error referring student",
            error: _context.t0
          });
        case 12:
        case "end":
...
exports.getReferredStudentsByJob = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var jobId, referredStudents;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          jobId = req.params.jobId;
          _context2.next = 4;
          return ReferredStudent.find({
            jobId: jobId
          });
        case 4:
          referredStudents = _context2.sent;
        ...
        case 8:
          ...
          _context2.t0 = _context2["catch"](0);
          res.status(500).json({
            message: "Error fetching referred students",
            error: _context2.t0
          });
        case 11:
        case "end":
...
exports.getReferredStudentById = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, referredStudent;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.params.id;
          _context3.next = 4;
          return ReferredStudent.findById(id);
        case 4:
          referredStudent = _context3.sent;
          if (referredStudent) {
            _context3.next = 7;
            break;
          }
        ...
        case 10:
          ...
          _context3.t0 = _context3["catch"](0);
          res.status(500).json({
            message: "Error fetching referred student",
            error: _context3.t0
          });
        case 13:
        case "end":
...
exports.updateReferredStudent = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, status, updatedStudent;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          ...
          _context4.next = 5;
          return ReferredStudent.findByIdAndUpdate(id, {
            status: status
          }, {
            "new": true
          });
        ...
        case 11:
          ...
          _context4.t0 = _context4["catch"](0);
          res.status(500).json({
            message: "Error updating referred student",
            error: _context4.t0
          });
        case 14:
        case "end":
...
exports.getReferredCountByJob = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var jobId, count;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          jobId = req.params.jobId;
          _context5.next = 4;
          return ReferredStudent.countDocuments({
            jobId: jobId
          });
        case 4:
          count = _context5.sent;
        ...
        case 8:
          ...
          _context5.t0 = _context5["catch"](0);
          res.status(500).json({
            message: "Error counting referred students",
            error: _context5.t0
          });
        case 11:
        case "end":
...
exports.getReferredCountByAffiliate = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var affiliateId, count;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
...
var ReferredStudentSchema = new Schema({
  studentName: {
    type: String,
    required: true
  },
  ...
  jobId: {
    ...
    ref: "AffiliateJob",
    // Reference to the Affiliate Job model
    required: true
  },
  affiliateId: {
    type: Schema.Types.ObjectId,
...
// routes/jobRoutes.js
var express = __webpack_require__(/*! express */ "express");
var _require = __webpack_require__(/*! ../controllers/affiliateJobController */ "./controllers/affiliateJobController.js"),
  createJob = _require.createJob,
  getJobs = _require.getJobs,
  deleteJob = _require.deleteJob,
  getJobByAffiliateId = _require.getJobByAffiliateId,
  editJobById = _require.editJobById,
  countJobsByAffiliateId = _require.countJobsByAffiliateId,
...
var _require = __webpack_require__(/*! ../controllers/affiliateController */ "./controllers/affiliateController.js"),
  ...
  getAffiliateProfile = _require.getAffiliateProfile,
...
var express = __webpack_require__(/*! express */ "express");
var router = express.Router();
var referredStudentController = __webpack_require__(/*! ../controllers/referredStudentController */ "./controllers/referredStudentController.js");
...
router.get("/referredstudents/:jobId", referredStudentController.getReferredStudentsByJob);

// Route to get a specific referred student by ID
router.get("/referredstudent/:id", referredStudentController.getReferredStudentById);

// Route to update the status of a referred student
router.put("/referredstudent/:id", referredStudentController.updateReferredStudent);

// Route to count referred students for a job
router.get("/referredstudentscount/:jobId", referredStudentController.getReferredCountByJob);
router.get("/referredcount/:affiliateId", referredStudentController.getReferredCountByAffiliate);
module.exports = router;
...
var affiliateRoutes = __webpack_require__(/*! ./routes/affiliateRoutes */ "./routes/affiliateRoutes.js");
var affiliateJobRoutes = __webpack_require__(/*! ./routes/affiliateJobRoutes */ "./routes/affiliateJobRoutes.js");
var referredStudentRoutes = __webpack_require__(/*! ./routes/referredStudentRoutes */ "./routes/referredStudentRoutes.js");
var app = express();
